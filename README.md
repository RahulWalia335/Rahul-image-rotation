...
# Introduction
--------------
In this project, I have taken an image and take an angle as input from the user and then rotate the image at the given angle in anti-clockwise direction.
# Requirements
--------------
...
int main()
{
    Mat src = imread("C:\\Users\\Rahul\\Desktop/elephant.jpg");           //reading image file in mat object
